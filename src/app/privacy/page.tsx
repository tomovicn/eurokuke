        ...
        <div className='max-w-2xl'>
          ...
          <div className='mt-8 prose prose-lg text-muted'>
            ...
            <ul>
              ...
              <li>
                For our business purposes, such as data analysis, audits, fraud monitoring and prevention, developing
                new products, enhancing, improving or modifying our services.
              </li>
            </ul>
            ...
            <ul>
              ...
              <li>
                The right of rectification - the right to have your information rectified if that information is
